          ...
          <div className="flex items-center justify-center py-2 bg-zinc-50 dark:bg-zinc-950 border border-zinc-200 dark:border-zinc-800 p-4 rounded-xl shadow-sm mb-14">
            <div className="bg-zinc-200/60 dark:bg-zinc-900 p-1 rounded-full flex items-center space-x-1 border border-zinc-250 dark:border-zinc-800/80">
              ...
              <button
                ...
                className={`px-4 py-1.5 text-[10px] font-black uppercase tracking-wider rounded-full transition-all duration-300 flex items-center space-x-2.5 cursor-pointer ${
                  isAnnual 
                    ? 'bg-white dark:bg-zinc-800 text-zinc-900 dark:text-white shadow-sm' 
                    : 'text-zinc-500 hover:text-zinc-800 dark:hover:text-zinc-300'
                }`}
